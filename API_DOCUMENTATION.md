...
**示例**: `GET /catalog/categories/DOGS`
...
**示例**: `GET /catalog/categories/DOGS/products?page=1&pageSize=10`
...
**示例**: `GET /catalog/products/FI-SW-01`
...
**示例**: `GET /catalog/search?keyword=puppy&page=1`
...
**示例**: `GET /orders?page=1&status=pending`
...
**示例**: `DELETE /admin/categories/BIRDS`
...
**示例**: `GET /admin/categories/search?keyword=dog`
...
**示例**: `PUT /admin/products/FI-SW-02`
...
**示例**: `DELETE /admin/products/FI-SW-02`
...
**示例**: `GET /admin/products/search?keyword=puppy&categoryId=DOGS`
...
**示例**: `GET /admin/orders?status=pending&page=1`
...
**示例**: `POST /admin/orders/1001/ship`
...
**示例**: `GET /admin/orders/search?keyword=1001`
...
**示例**: `POST /admin/users/user123/reset-password`
...
**示例**: `GET /admin/users/search?keyword=john`
